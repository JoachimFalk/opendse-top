...
public class Part4 {
	public static void main(String[] args) {
		...
		/*
		 * It is possible to define any kind of attribute that specifies requirements
		 * like bus load, memory requirements, etc.
		 */
		...
		/*
		 * It is possible to define connection constraints for resources. Here, we
		 * define that each link is of type "cc" and r1 can only connect to one of these
		 * links while r2 and r3 can connect to at most 2 of these links.
		 */
		...
		/*
		 * It is possible to define capacity constraints for resources. Here, we define
		 * a capacity constraints for our buses using the utilization value of the
		 * communication tasks.
		 */
		...
		/*
		 * For each resource that is not a bus, we specify to have a given amount of
		 * memory. This memory constraints how many tasks can be implemented on the
		 * specific resource.
		 */
		...
		/*
		 * It is also possible to define attributes not per task but per mapping. Here,
		 * the memory requirement for task t1 is overwritten in case it is mapped with
		 * m1.
		 */
